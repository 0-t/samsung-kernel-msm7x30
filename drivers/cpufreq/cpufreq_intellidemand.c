...
#define DEF_FREQUENCY_DOWN_DIFFERENTIAL (5)//10
#define DEF_FREQUENCY_UP_THRESHOLD (95)
#define DEF_SAMPLING_DOWN_FACTOR (1)//25
#define MAX_SAMPLING_DOWN_FACTOR (100000)
#define MICRO_FREQUENCY_DOWN_DIFFERENTIAL (5)//3
#define MICRO_FREQUENCY_UP_THRESHOLD (95)
#define MICRO_FREQUENCY_MIN_SAMPLE_RATE (30000)//10000
