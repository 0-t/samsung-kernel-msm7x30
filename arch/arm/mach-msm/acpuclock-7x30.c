...
static struct pll pll2_tbl[] = {
	...
	{  73, 0, 1, 0 }, /* 1401 MHz */
	{  78, 1, 3, 0 }, /* 1497 MHz */
	{  79, 1, 3, 0 }, /* 1516 MHz Original value 78 */
	{  83, 1, 3, 0 }, /* 1612 MHz */
	{  88, 1, 3, 0 }, /* 1708 MHz */
	{  93, 1, 3, 0 }, /* 1804 MHz */
	{  98, 1, 3, 0 }, /* 1900 MHz */
...
static struct clkctl_acpu_speed acpu_freq_tbl[] = {
	...
	{ MAX_AXI_KHZ, SRC_AXI, 1, 0, 61440000, 800, VDD_RAW(800) },
	{ 245760, PLL_3,    5, 2,  61440000,  800, VDD_RAW(800) },
	{ 368640, PLL_3,    5, 1,  122800000, 900, VDD_RAW(900) },
	/* AXI has MSMC1 implications. See above. */
	{ 768000, PLL_1,    2, 0,  153600000, 975, VDD_RAW(975) },
	/*
	 * AXI has MSMC1 implications. See above.
	 */
	...
	{ 1, 1612800, PLL_2, 3, 0, UINT_MAX, 1275, VDD_RAW(1275), &pll2_tbl[6]},
	{ 1, 1708800, PLL_2, 3, 0, UINT_MAX, 1300, VDD_RAW(1300), &pll2_tbl[7]},
	{ 1, 1804800, PLL_2, 3, 0, UINT_MAX, 1350, VDD_RAW(1350), &pll2_tbl[8]},
	{ 1, 1900800, PLL_2, 3, 0, UINT_MAX, 1400, VDD_RAW(1400), &pll2_tbl[9]},
	{ 0 }
};
